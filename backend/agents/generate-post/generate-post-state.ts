...
export const GeneratePostAnnotation = Annotation.Root({
  ...
  /**
   * The platform to generate the post for.
   */
  ...
  /**
   * Credentials for the platform (e.g. Instagram username/password).
   */
  ...
  /**
   * Whether the post requires human approval before scheduling.
   */
