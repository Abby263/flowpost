...
const creditPackages = [
  { id: "1", credits: 50, price: 9.99, bonus: 5 },
  { id: "2", credits: 150, price: 24.99, bonus: 15 },
  { id: "3", credits: 500, price: 69.99, bonus: 75 },
  { id: "4", credits: 2000, price: 199.99, bonus: 500 },
];
...
export default function BillingPage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl">
        ...
        <Card className="border-2">
          <CardContent className="p-5">
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t">
              <div>
                <p className="text-xs text-slate-500 mb-1">Credits/mo</p>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {creditPackages.map((pkg) => (
            <button
              ...
              className="p-4 border-2 rounded-xl hover:border-blue-300 hover:shadow-md transition-all text-left group disabled:opacity-50"
            >
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-bold text-slate-900">All Plans</h2>
        </div>
