        ...
        <section className="relative py-24 px-4 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-3xl mx-auto">
              Create intelligent workflows that discover content, generate
              stunning visuals, and post automatically to Instagram, Twitter,
              and LinkedIn. Let AI handle your social media.
            </p>
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              <Link href="/sign-up">
                <Button
                  size="lg"
                  className="text-lg px-8 h-14 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700"
                >
                  Start Free Trial
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="relative border-2 hover:shadow-xl transition-all">
                ...
                <CardContent className="pt-8">
                  ...
                  <p className="text-gray-600">
                    Define your content strategy: what to search for, where to
                    post, and how often. Set your style and preferences.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="relative border-2 hover:shadow-xl transition-all">
                ...
                <CardContent className="pt-8">
                  ...
                  <p className="text-gray-600">
                    Our AI discovers relevant content, curates the best pieces,
                    generates beautiful images, and crafts engaging captions.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="relative border-2 hover:shadow-xl transition-all">
                ...
                <CardContent className="pt-8">
                  ...
                  <p className="text-gray-600">
                    Posts are automatically published to your social media
                    accounts on schedule. Track performance from your dashboard.
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <Card className="hover:shadow-lg transition-all border-2">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Smart AI finds relevant content based on your topics and
                    location.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-all border-2">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Create stunning visuals with DALL-E 3 that match your brand
                    style.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-all border-2">
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Track all your posts, success rates, and workflow
                    performance.
                  </p>
                </CardContent>
              </Card>
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-10 opacity-90">
              Join thousands of creators and businesses saving 10+ hours per
              week
            </p>
            <Link href="/sign-up">
              <Button
                size="lg"
                variant="secondary"
                className="text-lg px-10 h-14 bg-white text-blue-600 hover:bg-gray-100"
              >
