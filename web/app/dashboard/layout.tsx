                ...
                <aside className="w-72 border-r bg-white/80 backdrop-blur-sm p-6 hidden md:block shadow-sm">
                    <div className="space-y-6">
                        ...
                        <div className="px-3">
                            ...
                            <p className="text-xs text-muted-foreground">Automate your social presence</p>
                        </div>
                                    ...
                                    <Link key={item.href} href={item.href}>
                                        ...
                                        >
                                            <div className="flex items-center gap-3 w-full">
                                                <Icon className={`h-5 w-5 shrink-0 ${isActive ? "" : "text-slate-600"}`} />
                                                <div className="flex flex-col items-start text-left">
                                                    <span className="font-medium">{item.label}</span>
                                                    <span className={`text-xs ${isActive ? "text-blue-100" : "text-muted-foreground"}`}>
                                                        {item.description}
                                                    </span>
                                                </div>
                                            </div>
                        ...
                        <div className="px-3 pt-4 border-t">
                            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100">
                                ...
                                <p className="text-xs text-blue-800 leading-relaxed">
                                    Schedule workflows to run automatically at specific times for consistent posting.
                                </p>
                            </div>
                        </div>
                    </div>
