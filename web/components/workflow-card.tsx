...
import { Play, Trash2, Edit, Clock, CheckCircle2, XCircle, Loader2, Calendar } from "lucide-react";
import { formatDistanceToNow } from "date-fns";
import { useRouter } from "next/navigation";
import { ScheduleWorkflowDialog, ScheduleData } from "@/components/schedule-workflow-dialog";
                ...
                <div className="hidden md:flex items-center gap-8 px-6 border-x shrink-0">
                    ...
                    <div className="text-center min-w-[120px]">
                        ...
                        <p className="text-sm font-medium">
                            {lastPostedAt
                                ? formatDistanceToNow(new Date(lastPostedAt), { addSuffix: true })
                                : "Never"}
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4 shrink-0">
                    <div className="flex flex-col gap-1.5">
                        <Badge 
                            ...
                            className={workflow.is_active ? "bg-green-600 text-xs justify-center" : "text-xs justify-center"}
                        >
                            {workflow.is_active ? "Active" : "Paused"}
                        </Badge>
                        {workflow.requires_approval && (
                            <Badge variant="secondary" className="bg-amber-100 text-amber-800 text-xs justify-center">
                                Approval
                            </Badge>
                        )}
                    </div>
